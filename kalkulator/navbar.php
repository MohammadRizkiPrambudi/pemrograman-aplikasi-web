...
<html lang="en">
  ...
  <body>
    <!-- dark mode -->
    <div id="theme">
      <div onclick="setDarkMode(true)" id="darkBtn" class="btn btn-dark">  <span>Dark</span></div>
    <div onclick="setDarkMode(false)" id="lightBtn" class="is-hidden btn btn-light"> <span>Light</span> </div>
</div>
    <!-- Bottom Navbar -->
